...
package com.fast.admin.api.feign.factory;

import com.fast.admin.api.feign.RemoteTokenService;
import com.fast.admin.api.feign.fallback.RemoteTokenServiceFallbackImpl;
...
public class RemoteTokenServiceFallbackFactory implements FallbackFactory<RemoteTokenService> {
	...
	@Override
	public com.fast.admin.api.feign.RemoteTokenService create(Throwable throwable) {
