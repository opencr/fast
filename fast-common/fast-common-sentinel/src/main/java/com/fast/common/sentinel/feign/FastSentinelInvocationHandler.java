 ...
 */
@Slf4j
public class FastSentinelInvocationHandler implements InvocationHandler {
	...
	FastSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			FastSentinelInvocationHandler other = (FastSentinelInvocationHandler) obj;
