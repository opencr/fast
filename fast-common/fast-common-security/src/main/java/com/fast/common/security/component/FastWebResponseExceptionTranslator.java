...
import com.fast.common.security.exception.*;
 ...
 */
@Slf4j
public class FastWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new FastAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
