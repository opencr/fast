 ...
 */
@Slf4j
public class FastResourceServerConfigurerAdapter extends ResourceServerConfigurerAdapter {
	...
	@Autowired
	private com.fast.common.security.component.FastBearerTokenExtractor pigBearerTokenExtractor;
	...
	public void configure(ResourceServerSecurityConfigurer resources) {
		...
		UserAuthenticationConverter userTokenConverter =
				new com.fast.common.security.component.FastUserAuthenticationConverter();
